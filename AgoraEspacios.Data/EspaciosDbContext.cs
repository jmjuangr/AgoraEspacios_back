            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                  ...
                  modelBuilder.Entity<Espacio>(entity =>
                  {
                        ...
                        entity.Property(e => e.Descripcion)
                              .HasMaxLength(500);
                        entity.Property(e => e.EsAccesible)
                              .IsRequired()
                              .HasDefaultValue(false);

                        entity.Property(e => e.RequiereAprobacionAdmin)
                              .IsRequired()
                              .HasDefaultValue(false);
                  ...
                  modelBuilder.Entity<Reserva>(entity =>
                  {
                        ...
                        // Restricción de combrobación:la fecha fin debe ser posterior a la fecha inicio
                        entity.ToTable(t =>
       {
